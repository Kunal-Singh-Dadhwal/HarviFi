...
const TokenizeForm = () => {
    ...
    const uploadToIPFS = async (file) => {
        ...
        const response = await fetch("https://api.pinata.cloud/pinning/pinFileToIPFS", {
            method: "POST",
            headers: {
                Authorization: `BearereyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..xaJ8M-VzA6LUJM-Cz8QTCflHR8YrXsrCrIR-4vXfHdg`, // Replace with your actual JWT token
            },
            body: formData,
        });
